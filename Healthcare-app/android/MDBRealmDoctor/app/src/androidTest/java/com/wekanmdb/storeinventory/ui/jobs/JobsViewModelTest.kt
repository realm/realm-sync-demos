...
class JobsViewModelTest{
    val jobsViewModel = JobsViewModel()
    ...
    @Throws(Exception::class)
    fun getStoreJob() {
        jobsViewModel.storeId.set("613a2ccaa3a6447e678816df")
        ...
        val store = jobsViewModel.storesresponseBody.getOrAwaitValue {  }
    ...
    @Test
    @Throws(Exception::class)
    fun getStoreJobFailure() {
        jobsViewModel.storeId.set("613a2d496f73d28f87be859d")
        apprealm?.executeTransaction { r: Realm ->
            val primaryKeyValue = ObjectId("613a2ccaa3a6447e678816df")
            storeItem = r.createObject(Stores::class.java, primaryKeyValue)
            storeItem?.name = "store 1"
    ...
    @Throws(Exception::class)
    fun getJobList() {
        jobsViewModel.userId.set("613a2d496f73d28f87be859d")
        ...
        val jobItem=jobsViewModel.jobresponseBody.getOrAwaitValue {}
    ...
    fun getJobListError() {
        jobsViewModel.userId.set("613a2d496f73d28f87be859d")
        val primaryKeyValue = ObjectId("613a2d496f73d28f87be859d")
        val userPrimaryKeyValue = ObjectId("613a2caf90e5f54ab3909c87")
        val storePrimaryKeyValue = ObjectId("613a2ccaa3a6447e678816df")
        val productPrimaryKeyValue = ObjectId("613a2caf90e5f54ab3909c87")
        val productQuantityprimaryKeyValue = ObjectId("614088f231cdc7039fd0a90e")

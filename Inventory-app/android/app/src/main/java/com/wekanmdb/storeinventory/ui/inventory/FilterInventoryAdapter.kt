    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        view.setOnClickListener {
            clickInventoryItem.onItemClick(
                storeInventoryList!!.get(position).productId.toString(),
                storeInventoryList!!.get(position).productName.toString(),
                storeInventoryList!!.get(position).quantity.toString()
            )
        }
